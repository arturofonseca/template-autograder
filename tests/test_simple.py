...
class TestLab2(unittest.TestCase):
    def setUp(self) -> None:
        ...
        """
        self.BREED_FILE_NAME = "dog_breed_characteristics.csv"
        self.DOG_FILE_NAME = "nyc_dogs.json"
    ...
    @weight(10)
    @number("3")
    def test_get_breed_data_for_dog(self):
    ...
    @weight(10)
    @number("4")
    def test_get_dogs_by_breed(self):
    ...
    @weight(10)
    @number("5")
    def test_get_names_by_breed(self):
    ...
    @weight(10)
    @number("7")
    def test_get_breeds_by_temperament(self):
    ...
    @weight(10)
    @number("8")
    def test_list_all_zip_codes(self):
